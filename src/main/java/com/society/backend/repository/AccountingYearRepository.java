...
public interface AccountingYearRepository extends JpaRepository<AccountingYear, Long> {
    ...
    Optional<AccountingYear> findBySocietyIdAndFyCode(Long societyId, String fyCode);
    boolean existsBySocietyIdAndFyCode(Long societyId, String fyCode);
    List<AccountingYear> findBySocietyIdAndIsClosedTrue(Long societyId);
    List<AccountingYear> findBySocietyIdAndIsClosedFalse(Long societyId);
